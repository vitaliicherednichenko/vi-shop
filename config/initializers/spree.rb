...
Rails.application.config.after_initialize do
  ...
  Rails.application.config.spree.page_sections << Spree::PageSections::ImageGrid
  Rails.application.config.spree.page_sections << Spree::PageSections::ImageSlider
  Rails.application.config.spree.page_sections << Spree::PageSections::FullscreenBanner
  Rails.application.config.spree.page_sections << Spree::PageSections::RiskReducers
  Rails.application.config.spree.page_sections << Spree::PageSections::CollectionSlider
  Rails.application.config.spree.page_sections << Spree::PageSections::YoutubeShortsSlider

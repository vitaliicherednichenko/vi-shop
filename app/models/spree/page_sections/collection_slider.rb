module Spree
  module PageSections
    class CollectionSlider < Spree::PageSection
      ...
      preference :heading, :string, default: Spree.t('page_sections.collection_banner.heading_default')
      ...
      def default_blocks
        [
          Spree::PageBlocks::ImageCollectionSlider.new(
      ...
      def available_blocks_to_add
        [
          Spree::PageBlocks::ImageCollectionSlider,
